...
@synthesize delegate, managedObject, itemTextField;
...
- (IBAction)onDoneButtonPressed:(id)sender {
    [managedObject setValue:itemTextField.text forKey:@"ordername"];
    [delegate didFinishEditingItem:self itemData:managedObject];
